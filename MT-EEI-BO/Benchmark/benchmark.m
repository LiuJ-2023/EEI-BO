...
%   - g2: global optima of Task 2
    switch(index)
        case 1 % complete intersection with high similarity, Griewank and Rastrigin
            ...
            Tasks(1).fnc = @(x)Griewank(x,Rotation_Task1_10,GO_Task1(:,1:dim));
            ...
            GO_Task2 = 10*ones(1,dim);
            Tasks(2).fnc = @(x)Rastrigin(x,Rotation_Task2_10,GO_Task2(:,1:dim));
        ...
        case 2 % complete intersection with medium similarity, Ackley and Rastrigin
            ...
            dim = 10;
            Tasks(1).dims = dim;
            Tasks(1).fnc = @(x)Ackley(x,Rotation_Task1_10,GO_Task1(:,1:dim));
        ...
        case 4 % partially intersection with high similarity, Rastrigin and Sphere
            ...
            dim = 10;
            Tasks(1).dims = dim;
            Tasks(1).fnc = @(x)Rastrigin(x,Rotation_Task1_10,GO_Task1(:,1:dim));
            Tasks(1).Lb=-50*ones(1,dim);
            Tasks(1).Ub=50*ones(1,dim);
        ...
        case 6 % partially intersection with low similarity, Ackley and Weierstrass
            ...
            dim = 5;
            Tasks(2).dims = dim;
            Tasks(2).fnc = @(x)Weierstrass(x,ROT5,GO_Task2(:,1:dim));
